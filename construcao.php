  ...
  <body>
    <section id="meio">
      <div class="container" id="meio-img">
        <a href="index.php">
          <img src="img/logo-blackink-clara.png" alt="logo" class="logo-meio" style="max-width: 100%;">
        </a>
        <hr id="divisoria-escura">
        <h2 class="text-center" style="color: #fff;">Vish... Aqui ainda não esta pronto, calma que em breve ta no ár!</h2>
        <img src="img/Tatuando esta página.png" alt="em construção" style="max-width: 100%;">
        <hr id="divisoria-escura">
